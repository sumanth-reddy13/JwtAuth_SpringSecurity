    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(req -> req.requestMatchers(WHITELIST_URLS).permitAll()
                        .requestMatchers("/api/v1/management/**").hasAnyRole(ADMIN.name(), MANAGER.name(), USER.name())
                ...
                .authenticationProvider(authenticationProvider)    // will be triggered for login
